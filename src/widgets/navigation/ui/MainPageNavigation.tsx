...
interface MainPageNavigationLinkProps {
...
const MainPageNavigationLink: FC<MainPageNavigationLinkProps> = ({ href, title, isActive }) => {
...
export const MainPageNavigation: FC<{}> = () => {
  ...
  const links: MainPageNavigationLinkProps[] = [
    {
      title: "Projects",
      href: "/projects",
      description:
